...
//************************ Transaction Array **********************************/
        ...
        $txnArray=array(
	        type=>'ernex_loyalty_purchase',
        	order_id=>$orderId,
	    	cust_id=>'my cust id',
	    	total_amount=>'1.00',		//total CC/cash purchase amount
	    	benefit_amount=>'1.00',		//amount used to calculate the points
	    	track2=>'',
            pan=>'0512020000001000348',
	    	expdate=>'0000',
	    	language_code=>'1',
            info=>''
           	);
